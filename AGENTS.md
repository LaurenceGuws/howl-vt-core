# Working on Our Beloved Terminal:
## START HUMAN RULES: NOT to BE TOUCHED by AGENTS! 
Terminal rules:
1. No compatibility/fallback/workaround/in-case code paths. Keep things KISS, DRY and unambiguous.
2. Naming convention and docstrings are to be treated in the same manner, keep details in md, file/fn/folder/comments names need to be simple, clean, and intentional.
