...
| `M8` Host Integration Readiness | `active` | `app_architecture/authorities/M8_FOUNDATION.md` | Architect-owned phase. M8-A contract closure is complete; M8-B seam audit is active with artifact `docs/review/m8/M8_SEAM_AUDIT.md`; engineer queue remains closed until M8-C gate matrix is published. |
