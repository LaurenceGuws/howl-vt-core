...
| `M5` Runtime Interface | `active` | `app_architecture/authorities/M5_FOUNDATION.md` | M5 execution is bounded by explicit start/end gates: M5-A contract closure, M5-B interface hardening, M5-C parity matrix, M5-D freeze handoff. |
