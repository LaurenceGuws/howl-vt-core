...
| `M8` Host Integration Readiness | `active` | `app_architecture/authorities/M8_FOUNDATION.md` | Architect-owned planning phase. Define host-readiness contract, API stability seams, and readiness gates before any implementation queue. |
