...
| `M7` Performance and Memory Discipline | `active` | `app_architecture/authorities/M7_FOUNDATION.md` | M7 authority to be published. Scope: performance audit, bounded allocations, hot-path analysis, memory discipline enforcement. |
